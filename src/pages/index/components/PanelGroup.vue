      ...
      <div class="card-panel" @click="handleSetLineChartData('newVisitis')">
        <div class="card-panel-icon-wrapper icon-people">
          <!-- <svg-icon icon-class="peoples" class-name="card-panel-icon" /> -->
            <d2-icon name="github" style="font-size: 60px;" class="d2-mr-10"/>
        </div>
      ...
      <div class="card-panel" @click="handleSetLineChartData('messages')">
        <div class="card-panel-icon-wrapper icon-message">
          <!-- <svg-icon icon-class="message" class-name="card-panel-icon" /> -->
            <d2-icon name="inbox" style="font-size: 60px;" class="d2-mr-10"/>
        </div>
        <div class="card-panel-description">
      ...
      <div class="card-panel" @click="handleSetLineChartData('purchases')">
        <div class="card-panel-icon-wrapper icon-money">
          <!-- <svg-icon icon-class="money" class-name="card-panel-icon" /> -->
            <d2-icon name="remove" style="font-size: 60px;" class="d2-mr-10"/>
        </div>
        <div class="card-panel-description">
      ...
      <div class="card-panel" @click="handleSetLineChartData('shoppings')">
        <div class="card-panel-icon-wrapper icon-shoppingCard">
          <!-- <svg-icon icon-class="shoppingCard" class-name="card-panel-icon" /> -->
            <d2-icon name="pie-chart" style="font-size: 50px;" class="d2-mr-10"/>
        </div>
        <div class="card-panel-description">
